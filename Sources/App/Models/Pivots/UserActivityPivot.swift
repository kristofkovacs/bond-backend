...
final class UserActivityPivot: ModifiablePivot {
    static var leftIDKey: ReferenceWritableKeyPath<UserActivityPivot, String> = \UserActivityPivot.userId
    
    static var rightIDKey: ReferenceWritableKeyPath<UserActivityPivot, Int> = \UserActivityPivot.activityId
